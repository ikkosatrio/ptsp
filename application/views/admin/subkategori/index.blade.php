				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table table-striped datatable-basic table-lg table-responsive">
		                    ...
		                    <tbody>
		                    	@foreach($subkategori as $key => $result)
		                         <tr>
		                        	<td align="center">{{($key+1)}}</td>
			                        <td style="width:300px;">
			                        	<a href="{{base_url('superuser/subkategori/update/'.$result->id_subkat.'/'.seo($result->id_kategori))}}">
			                        ...
			                        <td style="width:300px;">
			                        	<a href="{{base_url('superuser/subkategori/update/'.$result->id_subkat.'/'.seo($result->kode_subkat))}}">
			                        ...
			                        <td class="text-center">
			                        	<span class="text-size-small text-muted">
			                        		{{read_more(strip_tags($result->deskripsi_subkat),50)}}
			                        	</span>
			                        </td>
			                        <td class="text-center">
			                           <div class="btn-group">
